    ...
    return (
        <div id="container" style={{maxHeight:950, overflowY:"hidden", scrollBehavior:"smooth"}}>
            <div style={{ height: pageSize }}>
                ...
                }} onClick={() => clickLogo()} id="photo" style={{ transition: "0.5s", cursor: "pointer", width: 200, height: 200, borderRadius: 100, marginLeft: 800, marginTop: 350 }}
                ...
                <h1 style={{ marginLeft: 769, marginTop: 20, color: "pink" }} >Jennifer Oenning</h1>
            </div>
        </div>
    )
}
